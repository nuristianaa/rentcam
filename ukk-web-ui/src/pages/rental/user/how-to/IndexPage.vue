...
const steps = [
  ...
  },
  {
    ...
    cta: { href: 'https://wa.me/6283851071957?text=Hello%20Nuristiana%2C%20I%20want%20to%20confirm%20my%20booking%20payment.', icon: 'chat', label: 'Send Receipt via WhatsApp', color: 'wa', external: true },
  },
  {
    ...
    desc: 'Once your booking status changes to "Processing", come to our store in Karyawangi on your rental start date. Bring your ID (KTP) and prepare the deposit amount.',
    tips: [
    ...
    cta: { href: 'https://maps.app.goo.gl/tW7X2aR8Z6B2u4E81', icon: 'map', label: 'Open in Google Maps', color: 'navy', external: true },
  },
  {
    shortLabel: 'Use Gear',
    icon: 'camera',
