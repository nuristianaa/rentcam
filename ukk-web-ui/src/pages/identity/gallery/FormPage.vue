  ...
  <div>
    ...
    <h-form v-else @submit="submit" :meta="Meta" :modal="props" @back="back">
      <div class="row q-px-lg">
        ...
        <f-input col="6" v-model="dataModel.name" label="Name" />
        <f-input col="6" v-model="dataModel.description" label="Description" />
        ...
        <f-uploader boxClass="col-12 col-md-6 q-pa-sm" v-model="dataModel.file" :oldFile="dataModel.public_path" type="image" />
        <div class="col-12">
