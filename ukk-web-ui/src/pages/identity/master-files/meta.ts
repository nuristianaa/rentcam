...
export const Meta = {
  ...
  table: (H: any, C: any, L: any) => {
    ...
    return [
      ...
      { name: 'reference_code', label: L.module(meta, 'reference_code'), field: 'reference_code', align: 'left' },
      { name: 'is_public', formatter: 'boolean', label: L.module(meta, 'is_public'), field: 'is_public', align: 'left' },
