<template>
  <div>
    <r-table :meta="Meta" :columns="Meta.table(Helper, Constant, Lang)" v-model="dataModel" wrap-cells :selected="selectedData" @selected="selectedFunc" selection>
      <template #top-right>
      ...
      <template v-slot:body-cell-content="prp">
        <span>{{ Helper.truncateText(prp.props.value, 500) }}</span>
      </template>
    </r-table>
...
import FormModal from './NotesForm.vue'
