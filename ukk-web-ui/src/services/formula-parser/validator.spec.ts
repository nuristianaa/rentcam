...
circularTests.push(['c', '{b} + {a}', { a: '1', b: '{a} + {c} + 1' }, [{ token: { type: TokenType.ReferenceName, value: 'b' }, tokenIndex: 1, errorType: ErrorType.CircularReference }]])
circularTests.push(['VaR', '(1 + round({vaR}))', {}, [{ token: { type: TokenType.ReferenceName, value: 'vaR' }, tokenIndex: 8, errorType: ErrorType.CircularReferenceToItself }]])
circularTests.push(['a', '{B} + round({f})', { b: '{c} - 1', c: '{d} - 1', d: '{e} + 1', e: '{a}' }, [{ token: { type: TokenType.ReferenceName, value: 'B' }, tokenIndex: 1, errorType: ErrorType.CircularReference }]])
